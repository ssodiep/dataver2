...
col1.metric("Vốn Đầu tư (C₀)", f"{data['Vốn đầu tư']:,.0f} VNĐ")
    col2.metric("Dòng đời dự án (N)", f"{data['Dòng đời dự án']:.f} năm")
    col3.metric("WACC (k)", f"{data['WACC']:.2%}")
    col1.metric("Doanh thu Hàng năm (R)", f"{data['Doanh thu hàng năm']:,.f} VNĐ")
    col2.metric("Chi phí HĐ Hàng năm (C)", f"{data['Chi phí hoạt động hàng năm']:,.f} VNĐ")
